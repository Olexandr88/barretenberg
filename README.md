...
> [!WARNING]
> :warning: **<https://github.com/AztecProtocol/barretenberg> is a mirror-only repositorhy, please only use <https://github.com/AztecProtocol/aztec-packages>. Do not use this for any purpose other than reference.** :warning:
